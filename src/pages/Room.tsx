    ...
    <div id="page-room" className={theme}>
      <header>
        <div className="content">
            <div className="img-themeLightOrDark">
            <button onClick={hundleGoHome}
      ...
      <main>
        ...
        <form onSubmit={handleSendQuestion}>
          <textarea 
            className={theme === 'dark' ? 'textarea-dark' : ''}
          ...
          <div className="form-footer">
            {
              ...
              <div className="user-info">
                ...
                <span className={theme === 'dark' ? 'color-letter-dark' : ''}>{user.name}</span>
              </div>
              ) : (
        ...
        <div className="question-list">
          {questions.map(question => {
            return (
              ...
              >
                {
                  !question.isAnswered && (<button className={`like-button ${question.likeId ? 'liked' : ''}` }
                  type="button" 
